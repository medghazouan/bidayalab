...
import { Plus, Pencil, Trash2, Eye, MoreHorizontal, Calendar, Layers } from "lucide-react";
        ...
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {projects.map((project: any) => (
                    <div key={project._id} className="group bg-zinc-900/30 border border-white/5 rounded-3xl overflow-hidden hover:border-[#beff01]/30 transition-all duration-300 flex flex-col">
                        {/* Image Preview */}
                        ...
                        <div className="p-6 flex-1 flex flex-col">
                            ...
                            <div className="flex items-center justify-between pt-4 border-t border-white/5 mt-auto">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <Link href={`/dashboard/projects/${project._id}`} className="p-2 rounded-lg hover:bg-white/10 text-zinc-400 hover:text-[#beff01] transition-colors" title="Edit">
                                        <Pencil size={18} />
                                    </Link>
                                    <form action={async () => {
                                        "use server";
