    ...
    <section id="works-section" className="relative py-16 md:py-24 lg:py-32 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 md:px-8 lg:px-12">
        ...
        >
          ...
          >
            <span className="text-5xl md:text-6xl lg:text-7xl xl:text-8xl whitespace-nowrap block">Our Latest</span>
            <span className="bg-gradient-to-r from-[#beff01] via-[#d4ff4d] to-[#beff01] bg-clip-text text-transparent bg-[length:200%_auto] animate-gradient text-6xl sm:text-7xl md:text-8xl lg:text-8xl xl:text-8xl leading-[0.9] whitespace-nowrap block mt-2 pb-2">
