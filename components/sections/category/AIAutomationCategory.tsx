...
export default function AIAutomationCategory({ projects }: { projects: IProject[] }) {
  return (
    <div className="min-h-screen bg-[#030014] text-white pt-32 px-6 pb-24 overflow-hidden relative">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
             ...
             <p className="text-xl text-indigo-200/60 max-w-2xl mb-20">Next-generation intelligent workflows and chatbot solutions.</p>

             <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                 {projects.map((project) => (
                     <Link href={`/works/${project.slug}`} key={project._id} className="group bg-white/5 border border-white/5 hover:border-indigo-500 hover:bg-indigo-500/10 rounded-2xl p-8 transition-all backdrop-blur-sm flex flex-col justify-between min-h-[300px]">
                          <div>
