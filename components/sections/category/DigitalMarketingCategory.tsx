                            ...
                            <div className="p-8">
                                <div className="flex justify-between items-start mb-6">
                                    <div className="flex gap-2">
                                        {project.techStack?.slice(0, 2).map((p: string, i: number) => (<span key={i} className="px-2 py-1 rounded bg-green-500/10 text-green-400 text-[10px] uppercase font-bold">{p}</span>))}
                                    </div>
                                ...
                                {project.result && (
                                    <div className="inline-flex items-center gap-3 bg-black/40 rounded-lg px-4 py-2 border border-zinc-700/50">
                                        ...
                                        <span className="font-mono font-bold">{project.result}</span>
                                    </div>
                                )}
                            </div>
